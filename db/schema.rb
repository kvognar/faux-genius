...
ActiveRecord::Schema.define(version: 20141003002827) do
  ...
  add_index "articles", ["submitter_id"], name: "index_articles_on_submitter_id", using: :btree
  ...
  add_index "relationships", ["followed_type"], name: "index_relationships_on_followed_type", using: :btree
